namespace JimmyLinqUnitTests
{
	...
	public class ComicAnalyzerTests
	{
		...
		public void ComicAnalyzer_Should_Group_Comics()
		{
			...
			IEnumerable<IGrouping<PriceRange, Comic>> groups = ComicAnalyzer.GroupComicsByPrice(testComics, prices);
		...
		public void ComicAnalyzer_Should_Handle_Weird_Review_Scores()
		{
			Review[] testReviews = new[]
			{
				...
				new Review() { Issue = 1, Critic = Critics.RottenTornadoes, Score = 39161234.48931},
			...
			string[] expectedResults = new[]
			{
				...
				"RottenTornadoes rated #1 'Issue 1' 39161234,49",

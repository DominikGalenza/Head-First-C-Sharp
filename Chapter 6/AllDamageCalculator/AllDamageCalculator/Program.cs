internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        while (true)
        {
            Console.WriteLine("Choose the damage type: 0 for no magic or flaming, 1 for magic, 2 for flaming, 3 for both, anything else to quit.");
            ...
            Console.WriteLine("S for sword, B for bow, anything else to quit: ");

...
public class PlayerTests
{
	...
	public void TestDoYouHaveAny()
	{
		...
		List<string> threes = player.DoYouHaveAny(Values.Three, new Deck())
		...
		List<string> jacks = player.DoYouHaveAny(Values.Jack, new Deck())
			.Select(card => card.ToString())
			.ToList();
	...
	{
		Player player = new Player("Owen", new Deck());
